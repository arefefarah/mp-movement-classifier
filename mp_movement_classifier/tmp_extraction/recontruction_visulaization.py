...
def main():
    ...
    # for i in range(9):
    filename = f"subject_1_motion_07"
    ...
    pos_file = os.path.join(model_dir, "reconstructed_segment_motion_7.npy")
    ...
    imageio.mimsave(Path(output_path) / f'{filename}.gif', frames, fps = 30, loop=0)

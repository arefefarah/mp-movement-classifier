...
def main():
    ...
    folder_path = "./../../data/pymotion_quat_csv_files"
    motion_ids, processed_segments, segment_motion_ids = process_motion_data(folder_path=folder_path, data_type = "quaternion")
